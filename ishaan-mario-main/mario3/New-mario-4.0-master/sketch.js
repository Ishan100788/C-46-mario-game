var mario;
var platformGroup;
var marioAnimation, obstacleAnimation, wallAnimation, groundAnimation, coinAnimation;
var flag,coin;
var LOSE = 0;
var PLAY = 1;
var WIN = 2;
...
function preload()
{
  ...
  coinAnimation = loadAnimation("images/Coin.png")
}
...
function draw() {
  ...
  //set collider for coin 
  coin.spt.collide(platformGroup);
